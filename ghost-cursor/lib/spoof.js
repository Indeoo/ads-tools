    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4, getCDPClient(page).send('Browser.getWindowForTarget', { targetId: targetId })];
            case 1:
                window = _c.sent();
...
function path(start, end, optionsOrSpread) {
    var spreadOverride = typeof optionsOrSpread === 'number' ? optionsOrSpread : optionsOrSpread === null || optionsOrSpread === void 0 ? void 0 : optionsOrSpread.spreadOverride;
    var moveSpeed = typeof optionsOrSpread === 'object' && optionsOrSpread.moveSpeed;
    var defaultWidth = 100;
    var minSteps = 25;
    var width = 'width' in end && end.width !== 0 ? end.width : defaultWidth;
    var curve = (0, math_1.bezierCurve)(start, end, spreadOverride);
    var length = curve.length() * 0.8;
    var speed = typeof moveSpeed === 'number' ? (25 / moveSpeed) : Math.random();
...
var shouldOvershoot = function (a, b) {
    return (0, math_1.magnitude)((0, math_1.direction)(a, b)) > overshootThreshold;
};
...
var boundingBoxWithFallback = function (page, elem) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, getElementBox(page, elem)];
            case 1:
                box = _a.sent();
...
var createCursor = function (page, start, performRandomMoves) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _b.label = 1;
                    case 1:
                        if (!!vectors_1_1.done) return [3, 6];
                        v = vectors_1_1.value;
                        _b.label = 2;
                    case 2:
                        _b.trys.push([2, 4, , 5]);
    ...
    var randomMove = function (options) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 8, , 9]);
                    if (!!moving || movingRestricted) return [3, 3];
                    return [4, (0, exports.getRandomPagePoint)(page)];
                case 1:
                    rand = _a.sent();
                    return [4, tracePath(path(previous, rand, {
                            moveSpeed: options === null || options === void 0 ? void 0 : options.moveSpeed
                        }), true)];
                case 2:
                    _a.sent();
                    previous = rand;
                    _a.label = 3;
                case 3:
                    if (!((options === null || options === void 0 ? void 0 : options.moveDelay) !== undefined && options.moveDelay >= 0)) return [3, 5];
                    return [4, delay(Math.random() * options.moveDelay)];
                case 4:
                    _a.sent();
                    return [3, 7];
                case 5: return [4, delay(Math.random() * 2000)];
                case 6:
                    _a.sent();
                    _a.label = 7;
                case 7:
    ...
    var actions = {
        ...
        forceToggleRandomMove: function (random) {
            movingRestricted = !random;
        },
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.trys.push([2, 9, , 10]);
                            if (!((options === null || options === void 0 ? void 0 : options.hesitate) !== undefined)) return [3, 4];
                            return [4, delay(options.hesitate)];
                        case 3:
                            _a.sent();
                            _a.label = 4;
                        case 4: return [4, page.mouse.down()];
                        case 5:
                            _a.sent();
                            if (!((options === null || options === void 0 ? void 0 : options.waitForClick) !== undefined)) return [3, 7];
                            return [4, delay(options.waitForClick)];
                        case 6:
                            _a.sent();
                            _a.label = 7;
                        case 7: return [4, page.mouse.up()];
                        case 8:
                            _a.sent();
                            return [3, 10];
                        case 9:
                            ...
                            return [3, 10];
                        case 10:
                            if (!((options === null || options === void 0 ? void 0 : options.moveDelay) !== undefined && options.moveDelay >= 0)) return [3, 12];
                            return [4, delay(Math.random() * options.moveDelay)];
                        case 11:
                            _a.sent();
                            return [3, 14];
                        case 12: return [4, delay(Math.random() * 2000)];
                        case 13:
                            _a.sent();
                            _a.label = 14;
                        case 14:
                    ...
                    switch (_a.label) {
                        case 0:
                            go = function (iteration) { return __awaiter(_this, void 0, void 0, function () {
                                var elem, _a, handle, objectId, e_3, box, height, width, destination, dimensions, overshooting, to, correction, newBoundingBox;
                                var _b;
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        case 0:
                                            if (iteration > ((_b = options === null || options === void 0 ? void 0 : options.maxTries) !== null && _b !== void 0 ? _b : 10)) {
                                            ...
                                            if (!((options === null || options === void 0 ? void 0 : options.waitForSelector) !== undefined)) return [3, 2];
                                            return [4, page.waitForSelector(selector, {
                                                    timeout: options.waitForSelector
                                                })];
                                        case 1:
                                            _c.sent();
                                            _c.label = 2;
                                        case 2: return [4, page.$$(selector)];
                                        case 3:
                                            _a = __read.apply(void 0, [_c.sent(), 1]), handle = _a[0];
                                            elem = handle.asElement();
                                            return [3, 8];
                                        case 4:
                                            if (!((options === null || options === void 0 ? void 0 : options.waitForSelector) !== undefined)) return [3, 6];
                                            return [4, page.waitForSelector(selector, {
                                                    timeout: options.waitForSelector
                                                })];
                                        case 5:
                                            _c.sent();
                                            _c.label = 6;
                                        case 6: return [4, page.$(selector)];
                                        case 7:
                                            elem = _c.sent();
                                            _c.label = 8;
                                        case 8:
                                            if (elem === null) {
                                                throw new Error("Could not find element with selector \"".concat(selector, "\", make sure you're waiting for the elements with \"puppeteer.waitForSelector\""));
                                            }
                                            return [3, 10];
                                        case 9:
                                            elem = selector;
                                        ...
                                        case 10:
                                            ...
                                            if (!(objectId !== undefined)) return [3, 16];
                                            _c.label = 11;
                                        case 11:
                                            _c.trys.push([11, 13, , 16]);
                                        ...
                                        case 13:
                                            ...
                                            return [4, elem.evaluate(function (e) { return e.scrollIntoView({ block: 'center' }); })];
                                        case 14:
                                            _c.sent();
                                        ...
                                        case 15:
                                            _c.sent();
                                            return [3, 16];
                                        case 16: return [4, boundingBoxWithFallback(page, elem)];
                                        case 17:
                                            box = _c.sent();
                                            ...
                                            to = overshooting
                                                ? (0, math_1.overshoot)(destination, overshootRadius)
                                                : destination;
                                        ...
                                        case 18:
                                            _c.sent();
                                            if (!overshooting) return [3, 20];
                                            correction = path(to, __assign(__assign({}, dimensions), destination), {
                                        ...
                                        case 21:
                                            newBoundingBox = _c.sent();
                                            if (!!intersectsElement(to, newBoundingBox)) return [3, 23];
                                            return [4, go(iteration + 1)];
                                        case 22: return [2, _c.sent()];
                                        case 23: return [2];
                                    }
                                });
                            }); };
